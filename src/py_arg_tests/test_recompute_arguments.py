...
class TestRecomputeArguments(unittest.TestCase):
    def test_nr_arguments_update(self):
        ...
        old_ordinary_premises = \
            arg_theory.knowledge_base_ordinary_premises.copy()

        # Add -a to the ordinary premises.
        arg_theory.add_to_knowledge_base_ordinary_premises(
            arg_theory.argumentation_system.language['-a'])
