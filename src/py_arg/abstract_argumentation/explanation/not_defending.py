...
def get_not_defending(argumentation_framework: AbstractArgumentationFramework,
    ...
    attack the argument and to which the
    ...
    for extension in extensions:
        ...
        if argument not in extension:
            for defeater in attackers:
                ...
                no_def_against = [nodefense for nodefense in defenders
                                  if nodefense not in extension]
...
def get_no_self_defense(
    ...
    :return: a list of sets of arguments, each representing one or more
        ...
        attack either.
    """
    not_defending = get_not_defending(argumentation_framework, argument,
                                      extensions)
