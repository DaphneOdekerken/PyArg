...
def get_reach(argumentation_framework: AbstractArgumentationFramework,
              argument: Argument):
    """
    Obtain the arguments in the framework from which the argument can be reach
    via the attack relation and the distance
    between those arguments.

    :param argumentation_framework: The argumentation framework used to
    determine reach and distance.
    :param argument: The argument for which the reach and distance need to be
    calculated.
    :return: A set of arguments from which the argument can be reached and a
    dictionary with for each argument in the
    ...
    return recursive_reach(argumentation_framework, initial_reach, argument,
                           argument, 0, [], distance)


def recursive_reach(argumentation_framework, reach, argument, new_argument,
                    dist, visited, distance):
    """
    Obtain the arguments in the framework from which the argument can be reach
    via the attack relation and the
    ...
    :param argument: The argument for which the reach and distance need to be
        calculated.
    :param new_argument: An argument from argumentation_framework from which
        the argument is reachable.
    ...
    for pot_argument in argumentation_framework.arguments:
        if pot_argument in argumentation_framework.\
                get_incoming_defeat_arguments(new_argument) \
            ...
            recursive_reach(argumentation_framework, reach, argument,
                            pot_argument, dist + 1, visited, distance)
