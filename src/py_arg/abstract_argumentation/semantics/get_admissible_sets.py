...
class AdmissibleLabel(Enum):
    ...
    # Argument may not be included in an admissible set because not defended
    # by any IN argument.
    UNDEC = 5
...
def get_admissible_sets(
    ...
    return _recursively_get_admissible_sets(argumentation_framework,
...
def _recursively_get_admissible_sets(
    ...
    if all(labelling[argument] != AdmissibleLabel.BLANK for argument in
