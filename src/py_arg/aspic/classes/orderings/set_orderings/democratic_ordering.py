...
class DemocraticOrdering(Ordering):
    ...
    def rule_set_is_strictly_weaker_than(
        ...
        if not rule_set_b:
            return True
        return all([any([self.rule_is_strictly_weaker_than(
            rule_from_a, rule_from_b)
    ...
    def ordinary_premise_set_is_strictly_weaker_than(
        ...
        if not ordinary_premise_set_b:
            return True
        return all([any([self.ordinary_premise_is_strictly_weaker_than(
            ordinary_premise_from_a, ordinary_premise_from_b)
