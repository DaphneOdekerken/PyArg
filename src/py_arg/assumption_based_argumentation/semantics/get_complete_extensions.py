...
import py_arg.abstract_argumentation.semantics.get_complete_extensions as get_complete_extensions_af


def get_complete_extensions(aba_framework: AssumptionBasedArgumentationFramework) -> Set[FrozenSet[str]]:
