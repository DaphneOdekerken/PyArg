...
from py_arg.aspic.algorithms.justification.\
    compute_all_literal_grounded_justification_status_fast import \
    compute_all_literal_grounded_justification_status_fast
from py_arg.aspic.algorithms.justification.\
    compute_all_literal_grounded_justification_status_naive import \
    compute_all_literal_grounded_justification_status_naive
from py_arg.aspic.algorithms.justification.literal_labels import \
    LiteralLabels
...
def instantiate_argumentation_theory_generator():
    ...
    return ArgumentationTheoryGenerator(
        arg_sys, knowledge_literal_ratio=knowledge_literal_ratio,
        axiom_knowledge_ratio=axiom_knowledge_ratio)


def execute_grounded_labelling_experiment(
