...
class IncompleteArgumentationTheoryToJSONWriter(Writer):
    ...
    def to_dict(
        ...
        return {
            ...
            'axioms': [str(literal)
                       for literal in
                       incomplete_argumentation_theory.knowledge_base_axioms],
            'ordinary_premises':
                [str(literal)
            ...
            'ordinary_premise_preferences':
                [(str(premise_preference_tuple[0]),
                 ...
                 incomplete_argumentation_theory.ordinary_premise_preferences.
                 preference_tuples],
            'queryables':
                [str(literal)
                 for literal in incomplete_argumentation_theory.queryables]
                }
