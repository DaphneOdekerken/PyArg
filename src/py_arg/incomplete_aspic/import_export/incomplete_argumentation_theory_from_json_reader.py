...
class IncompleteArgumentationTheoryFromJsonReader:
    ...
    def from_json(json_object) -> IncompleteArgumentationTheory:
        ...
        queryables = [argumentation_system.language[queryable_str]
                      for queryable_str in json_object['queryables']]
        ...
        return IncompleteArgumentationTheory(
            argumentation_system, queryables, knowledge_base_axioms,
