...
class IncompleteArgumentationTheoryGenerator:
    def __init__(self, argumentation_system: ArgumentationSystem,
        ...
        :param argumentation_system: The argumentation system based on which
        this IncompleteArgumentationTheory will be.
        ...
        self.positive_literals = [
            literal for literal in normal_literals if literal.is_positive]
    ...
    def generate(self) -> IncompleteArgumentationTheory:
        ...
        negative_queryables = [
            self.argumentation_system.language['-' + str(pos_q)]
