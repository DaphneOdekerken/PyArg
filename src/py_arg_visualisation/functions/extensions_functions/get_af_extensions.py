...
from src.py_arg.algorithms.semantics.get_admissible_sets import get_admissible_sets
from src.py_arg.algorithms.semantics.get_complete_extensions import get_complete_extensions
from src.py_arg.algorithms.semantics.get_eager_extension import get_eager_extension
from src.py_arg.algorithms.semantics.get_grounded_extension import get_grounded_extension
from src.py_arg.algorithms.semantics.get_ideal_extension import get_ideal_extension
from src.py_arg.algorithms.semantics.get_preferred_extensions import get_preferred_extensions
from src.py_arg.algorithms.semantics.get_semistable_extensions import get_semistable_extensions
from src.py_arg.algorithms.semantics.get_stable_extensions import get_stable_extensions
