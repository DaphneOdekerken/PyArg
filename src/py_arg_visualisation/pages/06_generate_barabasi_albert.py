...
dash.register_page(__name__, name='GenerateBarabasiAlbert', title='Generate Barabasi-Albert AF')
# self, nr_of_arguments: int, prob_edge_rewiring: float,prob_cycle: float, nr_join_neighbours: int, seed: int = None)
left_column = dbc.Col([
    html.H2('Input'),
    html.Br(),
    ...
    dbc.Row([dbc.Col(html.B('Use Seed')),
             dbc.Col(dbc.Select(
                 ...
                 value='No', id='06-generate-barbasi-albert-use-seed-input'))]),
    ...
    dbc.Row([dbc.Col(html.B('Probability of argument in cycle')),
             dbc.Col(dcc.Slider( min=0.1, max=1, step=0.1, value=0.5,marks=None,
...
layout = html.Div([
    html.H1('Generate Random Barabasi-Albert Abstract Argumentation Framework'),
...
@callback(Output('06-generate-barbasi-albert-output', 'children'),
          ...
          State('06-generate-barbasi-albert-nr-join-neighbours-input', 'value'),
...
def generate_abstract_argumentation_framework(
        nr_clicks: int, nr_arguments: str,nr_join_neighbours: str, seed: str,use_seed: str, prob_cycle: str):
    if not nr_clicks:
    ...
    generator = BarabasiAlbert(nr_of_arguments=nr_arguments_int,nr_attach_node_to=nr_join_neighbours_int,prob_cycle=prob_cycle_float,seed=seed_int)
        ...
        [html.H2('Output'),
         dbc.Row([
             dbc.Col([html.B('Arguments'), dbc.Textarea(
                 ...
                 style={'height': '300px'},
                 id={'type': '06-generate-barbasi-albert-arguments-text', 'index': nr_clicks})]),
             dbc.Col([html.B('Defeats'), dbc.Textarea(
                 ...
                 style={'height': '300px'},
                 id={'type': '06-generate-barbasi-albert-defeats-text', 'index': nr_clicks})])
         ]),
         html.Br(),
         dbc.Row([
             dbc.InputGroup([
                 dbc.InputGroupText('Filename'),
                 dbc.Input(value='generated_ba_af', id={'type': '06-generate-barbasi-albert-filename', 'index': nr_clicks}),
                 dbc.InputGroupText('.'),
                 dbc.Select(options=[{'label': extension, 'value': extension}
                                     for extension in ['JSON', 'TGF', 'APX', 'ICCMA23']],
                            value='JSON', id={'type': '06-generate-barbasi-albert-extension', 'index': nr_clicks}),
                 dbc.Button('Download', id={'type': '06-generate-barbasi-albert-download-button', 'index': nr_clicks}),
             ]),
             dcc.Download(id={'type': '06-generate-barbasi-albert-downloader', 'index': nr_clicks})
         ])
         ]
...
@callback(
    Output({'type': '06-generate-barbasi-albert-downloader', 'index': MATCH}, 'data'),
    Input({'type': '06-generate-barbasi-albert-download-button', 'index': MATCH}, 'n_clicks'),
    State({'type': '06-generate-barbasi-albert-arguments-text', 'index': MATCH}, 'value'),
    State({'type': '06-generate-barbasi-albert-defeats-text', 'index': MATCH}, 'value'),
    State({'type': '06-generate-barbasi-albert-filename', 'index': MATCH}, 'value'),
    State({'type': '06-generate-barbasi-albert-extension', 'index': MATCH}, 'value'),
